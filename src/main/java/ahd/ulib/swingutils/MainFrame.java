...
public class MainFrame extends JFrame implements Runnable, StateBase<String, Container>, ElementBaseContainer, ConfigBase<String, Object> {
    ...
    private final Map<Long, String> eventLogs;
...
//        getJMenuBar().getMenu(4).getItem(0).addActionListener(e -> _gotoTray.run());
    ...
    private void log(String where, String what, String msg, String stacktrace, boolean exception) {
